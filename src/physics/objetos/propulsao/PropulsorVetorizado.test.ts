...
describe('PropulsorVetorizado', () => {
  it('atinge o comando dentro da taxa do atuador e desvia a força de empuxo', () => {
    ...
    const tanque = new TanquePropelente({
      id: 'tanque-vetorizado', massaBaseKg: 100, dimensoesM: new Vetor3(1, 1, 1), resistenciaColisaoJ: 10_000, resistenciaCalorK: 1_000,
    ...
    const propulsor = new PropulsorVetorizado({
      id: 'merlin-vetorizado', massaBaseKg: 100, dimensoesM: new Vetor3(1, 1, 1), resistenciaColisaoJ: 10_000, resistenciaCalorK: 1_000,
  ...
  it('não move o atuador quando a cadeia de sistemas deixa de autorizá-lo', () => {
    const propulsor = new PropulsorVetorizado({
      id: 'atuador-bloqueado', massaBaseKg: 100, dimensoesM: new Vetor3(1, 1, 1), resistenciaColisaoJ: 10_000, resistenciaCalorK: 1_000,
  ...
  it('mantém o conjunto sem rotação quando 5° alinham o empuxo ao centro de massa', () => {
    ...
    const tanque = new TanquePropelente({
      id: 'tanque-correcao-cinco-graus', massaBaseKg: 30_000, dimensoesM: new Vetor3(2.5, 4, 1), resistenciaColisaoJ: 1_000_000, resistenciaCalorK: 1_000,
    ...
    const merlin = new PropulsorVetorizado({
      id: 'merlin-correcao-cinco-graus', massaBaseKg: 470, dimensoesM: new Vetor3(1.2, 0.8, 1), resistenciaColisaoJ: 150_000, resistenciaCalorK: 1_000,
